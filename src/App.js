      ...
      <Router>
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
          <div className="container-fluid">
            <a className="navbar-brand" href="/"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRdWK7j0tDuQySJtiFoaacxBtjj8uIf-LSU9Q&usqp=CAU" alt="Logo" width="50%px" height="50%px" className="d-inline-block align-text-middle" />  </a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item dropdown">
                  <a className="nav-link dropdown-toggle" href="#" role="button onClick" data-bs-toggle="dropdown" aria-expanded="false">
                    Properties
                  </a>
                  <div className="dropdown-menu">
                    <a className="dropdown-item" href="/PropertiesToLet">To Let</a>
                    <a className="dropdown-item" href="/PropertiesForSale">For Sale</a>
                  </div>
                </li>
              </ul>
            </div>
